...
export const MapChangeButton = (pathname: string) => {
  ...
  <div class=${control.changeButtons}>
      <div id=flag-analysis class='${control.buttonContainer} ${
    pathname === '/map/flag-analysis' ? control.selectedFlag : ''
  }'>
          <img src="/svg/flag.svg" width="20px" alt="랭킹" />
          <div class=${control.text}>깃발분석</div>
      </div>
      <div id=ranking-in-map class='${control.buttonContainer} ${
    pathname === '/map/ranking-in-map' ? control.selectedRanking : ''
  }'>
          <img src="/svg/ranking.svg" width="20px" alt="랭킹" />
          <div class=${control.text}>맛집랭킹</div>
      </div>
      <div id=sales-distribution class='${control.buttonContainer} ${
    pathname === '/map/sales-distribution' ? control.selectedSales : ''
  }'>
